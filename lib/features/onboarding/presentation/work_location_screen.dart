...
class WorkLocationScreen extends StatelessWidget {
  ...
  final _officeController = TextEditingController(text: 'Motijheel, Dhaka');
  final _homeController = TextEditingController(text: 'Uttara Sector 4');
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SamewayDarkButton(
                    label: 'Continue',
                    onPressed: () => context.go(AppRoutes.officeId),
                  ),
